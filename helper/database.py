...
DB_NAME = os.environ.get("DB_NAME","natsusenpai")
DB_URL = os.environ.get("DB_URL",'mongodb+srv://natsunigero:td9vUoASAIMxUQQ4@natsusenpai.9n4f99e.mongodb.net/?retryWrites=true&w=majority')
